...
player1 = [True,True,False,False,True,False,False,False,False]
player2 = [False,True,False,False,True,False,False,False,False]
...
p1hitbox = [300,670-83,0,0] #x,y,width,height
p1hit = Rect(p1hitbox)

p2hitbox = [700,670-83,0,0] #x,y,width,height
p2hit = Rect(p2hitbox)
...
#========================================
    ...
    if keys[ord("a")] == 1 and player1[ONGROUND] == False:
        p1hitbox[X] -= 2
        player1[RIGHT] = False
        
    elif keys[ord("d")] == 1 and player1[ONGROUND] == False:
        p1hitbox[X] += 2
        player1[RIGHT] = True
...
#========================================
    ...
    if keys[K_LEFT] == 1 and player2[ONGROUND] == False:
        p2hitbox[X] -= 2
        player2[RIGHT] = False
        
    elif keys[K_RIGHT] == 1 and player2[ONGROUND] == False:
        p2hitbox[X] += 2
        player2[RIGHT] = True
